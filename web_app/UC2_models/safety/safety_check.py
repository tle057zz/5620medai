# ai_medical/safety/safety_check.py
"""
 Safety & Red-Flag Checker (Enhanced Version)

- Adds provenance tracking for all risk detections
- Excludes low-dose aspirin from NSAID nephrotoxicity rule when aspirin is the only NSAID present
- Supports additional FHIR resources: MedicationDispense, DetectedIssue (ingested into notes)
- Normalizes lab units for key analytes (now applied during extraction)
- Maintains full backward compatibility and deterministic outputs
"""
