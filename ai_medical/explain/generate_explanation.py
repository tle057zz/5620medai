# ai_medical/explain/generate_explanation.py
"""
Day 6 — Explanation Generator (Final, Truth-Grounded & Ollama Verified)

✅ Extracts Conditions, Medications, Observations, and Care Context from FHIR Bundle.
✅ Generates factual plain-language summaries.
✅ Uses local Ollama + Mistral if available (prints detection message).
✅ Deterministic and path-independent (no cloud calls).
"""
